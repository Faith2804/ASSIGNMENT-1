...
public class Serial
 {
    ...
    public static void main(String[] args) throws IOException{
       //* taking the input for the datafile name,filtersize and outputfilename  and assignning to variables
         ...
         String dataFileName  = inpt1[0]; //Input data file.eg; "sampleInpu100.txt"
         int f_size  = Integer.parseInt(inpt1[1]);//Filter size ranging from 3 to 21
         String outputFileName  = inpt1[2]; //Output data file.eg; "sampleOutput100.txt"
         File f = null;
